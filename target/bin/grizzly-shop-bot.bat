...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="grizzly-shop-bot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" Bot.Bot %CMD_LINE_ARGS%
